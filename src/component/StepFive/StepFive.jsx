...
const StepFive = () => {
	return (
		<article className='form-step-two relative h-full py-3 flex flex-col justify-center items-center'>
			<div className='form-step-body flex flex-col justify-center items-center'>
				<div className='step-five-logo'>
				...
				<div className='step-five-content'>
					...
					<p className=' text-center text-sm'>Thanks for confirming your subscription! We hope you have fun using our platform. If you ever need support, please feel free to email us at support@loremgaming.com.</p>
				</div>
			</div>
		</article>
	)
